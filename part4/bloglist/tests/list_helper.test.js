...
describe('total likes', () => {
  ...
  test('of bloglist of 1 is the likes of the solitary member', () =>
...
describe('favorite blog', () => {
  test('of empty bloglist is undefined', () => 
    expect(listHelper.favoriteBlog(blogs0)).toBe(undefined))
  test('of bloglist of 1 is the solitary member', () =>
    expect(listHelper.favoriteBlog(blogs1)).toEqual(blog1))
